...
public class WheelSkid : MonoBehaviour
{
    ...
    const float SKID_FX_SPEED = 0.8f; // Min side slip speed in m/s to start showing a skid
    const float MAX_SKID_INTENSITY = 20.0f; // m/s where skid opacity is at full intensity
    const float WHEEL_SLIP_MULTIPLIER = 8.0f; // For wheelspin. Adjust how much skids show
